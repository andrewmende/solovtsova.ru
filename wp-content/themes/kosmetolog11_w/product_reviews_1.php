<?php 
    ...
    if (!function_exists('theme_product_review_1')) {
        function theme_product_review_1() {
            ...
            <li itemprop="reviews" itemscope itemtype="http://schema.org/Review" <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
                <div  id="comment-<?php comment_ID(); ?>" class="comment_container  bd-productreview-1">
 ...
 col-md-1">
    <div class="bd-layoutcolumn-68 bd-column" ><div class="bd-vertical-align-wrapper"><div class=" bd-reviewavatar-1"><?php echo theme_get_avatar(array('class' => ' bd-imagestyles', 'attributes' => ''), true); ?></div></div></div>
</div>
	
		<div class=" bd-columnwrapper-69 
 col-md-11">
    <div class="bd-layoutcolumn-69 bd-column" ><div class="bd-vertical-align-wrapper"><div class=" bd-reviewmetadata-1">
...
<?php
    ...
    for ($i = 1; $i <= 5; $i++) {
        ...
        echo '<span class="  bd-icon bd-icon-3 ' . $active_class . '"></span>';
    }
    echo '<strong itemprop="ratingValue" style="display:none">' . $rating . '</strong>';
?>
</div>
	
		<div itemprop="description" class="description  bd-reviewtext-1"><?php comment_text(); ?></div></div></div>
</div>
            </div>
        </div>
    </div>
...
<div class=" bd-productreviews-1">
    ...
    echo str_replace(
        ...
        array(
            ' class="comment-respond  bd-reviewform-1',
            '<div  class=" bd-container-39 bd-tagstyles"><h2',
            '</h2></div>',
            'type="text"  class=" bd-bootstrapinput form-control input-lg"',
            '<textarea id="comment_area_1"  class=" bd-bootstrapinput form-control input-lg"',
