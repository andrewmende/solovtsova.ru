...
<body <?php body_class(' hfeed bootstrap bd-body-7  bd-pagebackground  bd-margins'); /*   */ ?>>
<?php include 'templates/header.php'; ?>
	
		<div class=" bd-stretchtobottom-2 bd-stretch-to-bottom mt" data-control-selector=".bd-contentlayout-7">
<div class="bd-contentlayout-7  bd-sheetstyles  bd-no-margins bd-margins" >
 ...
 <?php 
        $post_id = get_the_ID();
        if (($post_id<>47)&&($post_id<>571)&&($post_id<>115)) {
            theme_sidebar_area_5();
        }
