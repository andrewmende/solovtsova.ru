<?php $GLOBALS['theme_current_template_info'] = array('name' => 'blogTemplate', 'allow_sample_posts' => true); ?>
...
<body <?php body_class(' hfeed bootstrap bd-body-5  bd-pagebackground  bd-margins'); /*   */ ?>>
<?php include 'header.php'; ?>
	
		<div class=" bd-stretchtobottom-3 bd-stretch-to-bottom mt" data-control-selector=".bd-contentlayout-5">
