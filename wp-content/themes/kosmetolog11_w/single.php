...
<body <?php body_class(' hfeed bootstrap bd-body-6  bd-pagebackground  bd-margins'); /*   */ ?>>
<?php include 'templates/header.php'; ?>
	
		<div class=" bd-stretchtobottom-4 bd-stretch-to-bottom mt" data-control-selector=".bd-contentlayout-6">
