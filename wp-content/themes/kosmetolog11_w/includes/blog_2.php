...
?>
                        ...
                        <div class="separated-item-34 col-md-12 ">
                            ...
                            <div class="bd-griditem-34">
                                <article id="<?php echo $id; ?>" class=" bd-article-3 clearfix hentry <?php echo $class; if (theme_is_preview()) echo ' bd-post-id-' . theme_get_the_ID(); ?>">
    <?php
...
?>
    ...
    'class' => ' bd-postimage-7 bd-no-margins',
...
?>
<div class=" bd-postcontent-2 bd-tagstyles  entry-content bd-contentlayout-offset" <?php echo $editor_attrs; ?>>
