...
?>
        <?php
    ob_start();
    theme_print_sidebar('default', 'default_9_2');
    ...
    theme_print_sidebar_content($current_sidebar_content, 'primary', ' bd-primarywidgetarea-2 hidden-xs bd-no-margins clearfix', '');
?>
 ...
 $theme_hide_sidebar_area ||
            ...
            <aside class="bd-sidebararea-5-column hidden-xs bd-no-margins  bd-flex-vertical bd-flex-fixed <?php if ($hide) echo ' hidden bd-hidden-sidebar'; ?>">
