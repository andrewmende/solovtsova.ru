...
?>
		...
		<?php if ( isset($product_view['link']) && isset($product_view['title']) ){ ?><div class=" bd-producttitle-4"><a itemprop="name" href="<?php echo $product_view['link']; ?>"><?php echo $product_view['title']; ?></a></div><?php } ?>
...
?>
        <span class="price"><?php
            echo theme_price_html(array(
                ...
                'old_price' => array(
                    'wrap_start'        => '<div class=" bd-pricetext-6">',
                    'wrap_end'          => '</div>',
                    'label_class'       => false,
                    'label_attributes'  => '',
                ...
                'price' => array(
                    'wrap_start'        => '<div class=" bd-pricetext-5">',
                    'wrap_end'          => '</div>',
                    'label_class'       => false,
                    'label_attributes'  =>'',
