...
function theme_breadcrumbs_items_1(){
    ...
    $shop_item = '';
    if (theme_woocommerce_enabled() && get_option('woocommerce_prepend_shop_page_to_urls') == "yes" && woocommerce_get_page_id( 'shop' ) && get_option( 'page_on_front' ) !== woocommerce_get_page_id( 'shop' ) ){
        $shop_item = theme_breadcrumbs_link_1(get_permalink( woocommerce_get_page_id('shop') ), get_the_title( woocommerce_get_page_id('shop') ), get_the_title( woocommerce_get_page_id('shop') ));
    }
    ...
    if (theme_woocommerce_enabled() && is_post_type_archive('product') && get_option('page_on_front') !== woocommerce_get_page_id('shop') ) {
...
?>
    ...
    <span class=" bd-breadcrumbstext-1"><span><?php echo $text; ?></span></span>
