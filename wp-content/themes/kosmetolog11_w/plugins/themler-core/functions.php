...
function themler_add_scripts_and_styles2() {
    wp_register_style("themler-core-upage", THEMLER_PLUGIN_URL . 'shortcodes/assets/css/upage.css', array(), THEMLER_PLUGIN_VERSION);
    wp_enqueue_style("themler-core-upage");
}
add_action('wp_enqueue_scripts', 'themler_add_scripts_and_styles2', 1001);
