                ...
                <tr>
                    <td colspan="6">
                        <div class=" bd-container-53 bd-tagstyles bd-custom-button">
                            ...
                            <a href="<?php echo $woocommerce->cart->get_checkout_url(); ?>" class=" bd-button-15"><?php _e('Proceed to Checkout', 'woocommerce'); ?></a>
                            <?php
                            ...
                            <td class="product-quantity">
                                <?php
                                    if ( $_product->is_sold_individually() ) {
                                        ...
                                        $product_quantity = sprintf( '<div class="quantity"><input type="%s" name="cart[%s][qty]" data-min="%s" data-max="%s" value="%s" size="4" title="Qty" class="qty  bd-bootstrapinput form-control input-lg" maxlength="12" /></div>', theme_wc_quantity_buttons_supported() ? 'text' : 'number', $cart_item_key, $data_min, $data_max, esc_attr( $cart_item['quantity'] ));
                                    }
