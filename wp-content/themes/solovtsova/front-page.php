	...
	<div id="primary" class="content-area container">
		<div id="main" class="site-main row" role="main">
			...
			<div class="col-md-9">
				...
				?>
				<div class="action">
    				<img src='/wp-content/themes/solovtsova/img/actions.png' class="img-fluid">
				</div>
	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
	  ...
	  <div class="carousel-inner">
	    <div class="carousel-item active">
	      <img class="d-block w-100" src="/wp-content/themes/solovtsova/img/slider-2.png" alt="First slide">
	    </div>
	    <div class="carousel-item">
	      <img class="d-block w-100" src="/wp-content/themes/solovtsova/img/slider-3.png" alt="Second slide">
	    </div>
	  </div>
